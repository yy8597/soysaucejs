soysauce.carousels = (function() {
	...
	function Carousel(selector) {
		...
		this.gotoPos = function(x, fast, jumping) {
			var self = this;
		...
		this.slideForward = function(fast) {
		...
		this.slideBackward = function(fast) {
		...
		this.handleInterrupt = function(e) {
		...
		this.toggleZoom = function(e1, e2, xDist, yDist) {
