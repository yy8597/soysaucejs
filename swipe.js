 ...
 * BB-Carousel
 *
 * Based on Swipe.js by Brad Birdsall
*/

window.BBCarousel = function(element, options) {
	...
	this.bullets_container = this.options.bullets || '.carousel_position';
	...
	transitionEnd: function(e) {
		...
		if (typeof this.bullets !== 'undefined') {
			...
			if (i !== 0) {
				...
				this.bullets[this.index].className = this.active_class;
			}			
		}
